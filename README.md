...
The application demonstrates practical use of backend and frontend technologies, database integration, and role-based access control in a complete web system.* Monitor participants
* View statistics
